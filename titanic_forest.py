...
# train_data = pd.DataFrame(train_data, columns = ['Pclass','Age', 'Sex', 'SibSp', 'Parch'])
# test_data = pd.DataFrame(test_data, columns = ['Pclass','Age', 'Sex', 'SibSp', 'Parch'])
#==============================================================================
...
#rfr = AdaBoostClassifier(n_estimators = 1000)  
...
score = cross_val_score(rfr, train_data, train_data_survival)
